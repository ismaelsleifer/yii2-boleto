    ...
    public function getNossoNumero(){
        if(empty($this->nossoNumero)){
            if (!empty($this->barras)) {
                ...
                $this->nossoNumero = str_replace(".", "", substr($this->ipte, 12, 11)) . str_replace(".", "", substr($this->ipte, 25, 9));
            } else {
    ...
    public function desenhaBarras(){
        ...
        while (strlen($texto) > 0) {
            ...
            for($i = 1; $i < 11; $i += 2){
                ...
                $bar .= " src='{$this->bundle->baseUrl}/images/p.gif' width={$f1} height={$altura} border=0><img
                          src='{$this->bundle->baseUrl}/images/b.gif' width={$f2} height={$altura} border=0><img";
            }
        }

        $bar .= " src='{$this->bundle->baseUrl}/images/p.gif' width={$largo} height={$altura} border=0><img
                 src='{$this->bundle->baseUrl}/images/b.gif' width={$fino} height={$altura} border=0><img
                 src='{$this->bundle->baseUrl}/images/p.gif' width=1 height={$altura} border=0></div>";
