...
class Boleto extends Widget{
    ...
    public function init(){
        $view = $this->getView();
        $this->bundle = BoletoAsset::register($view);
    }
    ...
    public function desenhaBarras(){
        ...
        ?>
            <div style="overflow:hidden;width:417px;height:50px;">
                <img src="<?=$this->bundle->baseUrl?>/images/p.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
                src="<?=$this->bundle->baseUrl?>/images/b.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
                src="<?=$this->bundle->baseUrl?>/images/p.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
                src="<?=$this->bundle->baseUrl?>/images/b.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
                <?php
                $texto = $valor ;
                if((strlen($texto) % 2) <> 0){
                ...
                while (strlen($texto) > 0) {
                    ...
                    for($i=1;$i<11;$i+=2){
                        ...
                        ?>
                        src="<?=$this->bundle->baseUrl?>/images/p.gif" width=<?php echo $f1?> height=<?php echo $altura?> border=0><img
                        <?php
                        if (substr($f, $i, 1) == "0") {
                            $f2 = $fino;
                        } else {
                        ...
                        ?>
                        src="<?=$this->bundle->baseUrl?>/images/b.gif" width=<?php echo $f2?> height=<?php echo $altura?> border=0><img
                        <?php
                    }
                }
                ...
                // Draw guarda final
                ?>
                src="<?=$this->bundle->baseUrl?>/images/p.gif" width=<?php echo $largo?> height=<?php echo $altura?> border=0><img
                src="<?=$this->bundle->baseUrl?>/images/b.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
                src="<?=$this->bundle->baseUrl?>/images/p.gif" width=<?php echo 1 ?> height=<?php echo $altura?> border=0>
            </div>
            <?php
        } //Fim da fun��o
